...
import { v4 as uuidv4 } from "uuid"; // Import UUID library for generating random IDs
...
export default function NewItem({ onAddItem }) {
  ...
  return (
    <div className="m-4 max-w-md bg-white bg-opacity-85 p-6 rounded-lg shadow-md">
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <input
            ...
            className="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 text-black"
          />
        </div>
        <div className="flex justify-between items-center">
          <div className="flex items-center bg-white p-2 rounded-lg shadow-md w-48">
